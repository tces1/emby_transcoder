...
.empty{text-align:center;padding:35px;color:#8297b5}@media(max-width:760px){.workers{grid-template-columns:1fr}.pipeline{grid-template-columns:1fr}.arrow{transform:rotate(90deg)}}
...
const bytes=n=>{n=Number(n||0);if(n>=1073741824)return(n/1073741824).toFixed(2)+' GiB';if(n>=1048576)return(n/1048576).toFixed(1)+' MiB';return(n/1024).toFixed(1)+' KiB'};
